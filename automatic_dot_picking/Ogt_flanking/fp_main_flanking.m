...
basedir = ['/home/xiaoze/Desktop/user_folders/Xiaoze/FRET-FISH/' s.setname]; %'/Volumes/projects/FRET-FISH/' '/Volumes/AM/FRET-FISH/' '/Users/anamota/Desktop/'
    s.calcfolder = [basedir '_calc/'];       
    s.imagefolder = [basedir '/']; 
    s.donorchannel = 'tmr';
    s.acceptorchannel = 'Cy5';
    s.dnachannel = 'dapi';
return
